...
<AnimDB FragDef="Animations/Mannequin/ADB/ArkPlayerFragments.xml" TagDef="Animations/Mannequin/ADB/ArkPlayerTags.xml">
 <SubADBs>
  <SubADB Tags="lure+neuromod+crawl+slaveHuman" File="Animations/Mannequin/ADB/ArkLureFFEvent.adb"/>
 </SubADBs>
 <FragmentList>
  <Wpn_Reload>
  ...
  <Fp_Bump>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="lure+hobbled">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
  ...
  <Climb>
   ...
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="lure+MediumClimb">
    <AnimLayer>
  ...
  <GripAdjust>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="lure">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="GripPoses_1p_Lure" flags="Loop"/>
    </AnimLayer>
   </Fragment>
  </GripAdjust>
  <Wpn_Throw_In>
  ...
  <Wpn_PickUp>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="lure">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.1"/>
     <Animation name="1p_PickUp_Lure"/>
    </AnimLayer>
    <ProcLayer>
     <Blend ExitTime="0.053125024" StartTime="0" Duration="0.30000001"/>
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_WPN_Grenade_Lure_Inspect_Pt1"/>
       <StopTrigger value="null"/>
       <FireAndForget value="false"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_WPN_Grenade_Lure_Inspect_Pt2"/>
       <StopTrigger value="null"/>
       <FireAndForget value="false"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
  ...
  <DisarmPlayer_Struggle>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="lure+disarm">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="1p_Disarm_Loop_Lure" flags="Loop"/>
    </AnimLayer>
   </Fragment>
  </DisarmPlayer_Struggle>
  <DisarmPlayer_PlayerWin>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="lure+disarm">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="1p_Disarm_PlayerWin_Lure"/>
    </AnimLayer>
   </Fragment>
  </DisarmPlayer_PlayerWin>
  <DisarmPlayer_PlayerFail>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="lure+disarm">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="1p_Disarm_PlayerFail_Lure"/>
    </AnimLayer>
    <ProcLayer>
