...
<AnimDB FragDef="Animations/Mannequin/ADB/ArkPlayerFragments.xml" TagDef="Animations/Mannequin/ADB/ArkPlayerTags.xml">
 <SubADBs>
  <SubADB Tags="emp+slaveHuman" File="Animations/Mannequin/ADB/ArkEmpFFEvent.adb"/>
 </SubADBs>
 <FragmentList>
  <Wpn_Select>
   ...
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="emp+inCombat">
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_Grenade_EMP_Select_Combat"/>
   ...
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="emp">
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_Grenade_EMP_Select"/>
       <StopTrigger value="null"/>
       <FireAndForget value="false"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
  ...
  <Fp_Bump>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="emp+hobbled">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
  ...
  <Climb>
   ...
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="emp+MediumClimb">
    <AnimLayer>
  ...
  <Wpn_Deploy>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="emp">
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_Grenade_EMP_Deploy"/>
       <StopTrigger value="null"/>
       <FireAndForget value="false"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
  ...
  <GripAdjust>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="emp">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="GripPoses_1p_Emp" flags="Loop"/>
    </AnimLayer>
   </Fragment>
  </GripAdjust>
  <Wpn_Throw_In>
  ...
  <Wpn_PickUp>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="emp">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.1"/>
     <Animation name="1p_PickUp_Emp"/>
    </AnimLayer>
    <ProcLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.30000001"/>
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_Grenade_EMP_Inspect"/>
       <StopTrigger value="null"/>
       <FireAndForget value="false"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
  ...
  <DisarmPlayer_Struggle>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="emp+disarm">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="1p_Disarm_Loop_Emp" flags="Loop"/>
    </AnimLayer>
   </Fragment>
  </DisarmPlayer_Struggle>
  <DisarmPlayer_PlayerWin>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="emp+disarm">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="1p_Disarm_PlayerWin_Emp"/>
    </AnimLayer>
   </Fragment>
  </DisarmPlayer_PlayerWin>
  <DisarmPlayer_PlayerFail>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="emp+disarm">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="1p_Disarm_PlayerFail_Emp"/>
    </AnimLayer>
    <ProcLayer>
