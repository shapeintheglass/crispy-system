 ...
 <FragmentList>
  ...
  <Wpn_Reload>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="stungun">
    ...
    <ProcLayer>
     <Blend ExitTime="0.1" StartTime="0" Duration="5.9604645e-08"/>
     <Procedural type="ActionEvent">
      <ProceduralParams>
  ...
  <Fp_Bump>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="stungun+hobbled">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0"/>
  ...
  <Wpn_Malfunction>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="stungun">
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_Taser_Fire_Broken"/>
       <StopTrigger value=""/>
       <FireAndForget value="false"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
    ...
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_WPN_StunGun_SP_Malfunction_Spark"/>
       <StopTrigger value="null"/>
       <FireAndForget value="false"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
    ...
    <ProcLayer>
     <Blend ExitTime="0.175" StartTime="0" Duration="0.30000001"/>
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_WPN_StunGun_SP_Malfunction_pt1"/>
       <StopTrigger value="null"/>
       <FireAndForget value="false"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
  ...
  <Wpn_Emp>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="stungun">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="1p_Disrupted_Stungun"/>
    </AnimLayer>
    <ProcLayer>
     <Blend ExitTime="0.0062500001" StartTime="0" Duration="0.30000001"/>
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_WPN_StunGun_EMPed"/>
       <StopTrigger value="null"/>
       <FireAndForget value="false"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
  ...
  <DisarmPlayer_Struggle>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="stungun+disarm">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="1p_Disarm_Loop_Stungun" flags="Loop"/>
    </AnimLayer>
   </Fragment>
  </DisarmPlayer_Struggle>
  <DisarmPlayer_PlayerWin>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="stungun+disarm">
    <AnimLayer>
     <Blend ExitTime="0" StartTime="0" Duration="0.2"/>
     <Animation name="1p_Disarm_PlayerWin_Stungun"/>
    </AnimLayer>
   </Fragment>
  </DisarmPlayer_PlayerWin>
  <DisarmPlayer_PlayerFail>
   <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" Tags="stungun+disarm">
    <AnimLayer>
     ...
     <Animation name="1p_Disarm_PlayerFail_Stungun"/>
    </AnimLayer>
    <ProcLayer>
     <Blend ExitTime="0.33125001" StartTime="0" Duration="0"/>
     <Procedural type="ActionEvent">
      <ProceduralParams>
