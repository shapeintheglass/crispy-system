...
function ArkBeta_x.IsInvulnerable(A0_1639)
  local L1_1640
  L1_1640 = A0_1639.PropertiesInstance
  L1_1640 = L1_1640.bIsInvulnerable
  L1_1640 = L1_1640 == true
  return L1_1640
end
function ArkBeta_x.OnDeathCustom(A0_1641, A1_1642)
  if A0_1641.UpdateDisplayName then
    A0_1641:UpdateDisplayName()
  end
  ArkNpc.OnDeathCustom(A0_1641, A1_1642)
end
function ArkBeta_x.OnLureSignal(A0_1643, A1_1644, A2_1645, A3_1646)
  A0_1643.arknpc:OnLured(A1_1644)
end
function ArkBeta_x.OnSpawn(A0_1647, A1_1648)
  BasicActor.OnSpawn(A0_1647, A1_1648)
  A0_1647:Activate(1)
end
function ArkBeta_x.OnUpdate(A0_1649, A1_1650)
end
function ArkBeta_x.Server.OnStartGame(A0_1651)
  if not A0_1651.arknpc:IsDead() then
    A0_1651.arknpc:AttachGameEffect(15)
    if A0_1651.arknpc:HasArkMetaTag("9469288860501638616") then
      A0_1651.arknpc:AttachGameEffect(4510)
    end
  end
end
function ArkBeta_x.OnNpcKilled(A0_1652)
  A0_1652.arknpc:DetachGameEffect(15)
  if A0_1652.arknpc:HasArkMetaTag("9469288860501638616") then
    A0_1652.arknpc:DetachGameEffect(4510)
  end
  A0_1652:SetupInventoryOnDeath()
  if A0_1652.PropertiesInstance.bSpawnHumanLoot then
    A0_1652.Properties.loottables_HumanLootTable:gsub("([^,]+)", function(A0_1653)
      local L2_1654
      L2_1654 = _UPVALUE0_
      L2_1654[#_UPVALUE0_ + 1] = A0_1653
    end)
    if #{} > 0 then
      Ark.SpawnLootFromTable(({})[math.random(#{})], A0_1652.id)
    end
  end
end
