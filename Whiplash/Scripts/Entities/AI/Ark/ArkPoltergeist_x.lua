...
ArkPoltergeist_x = {
  ...
  Properties = {
    ...
    PoltergeistEffects = {
      ...
      attachmenteffects_DisarmEffect = "",
...
function ArkPoltergeist_x.IsInvulnerable(A0_1773)
  local L1_1774
  L1_1774 = A0_1773.PropertiesInstance
  L1_1774 = L1_1774.bIsInvulnerable
  L1_1774 = L1_1774 == true
  return L1_1774
end
function ArkPoltergeist_x.Server.OnStartGame(A0_1775)
  if not A0_1775.arknpc:IsDead() then
    A0_1775.arknpc:AttachGameEffect(2)
    A0_1775.arknpc:AttachGameEffect(3)
  end
end
function ArkPoltergeist_x.OnNpcKilled(A0_1776)
  A0_1776.arknpc:DetachGameEffect(2)
  A0_1776.arknpc:DetachGameEffect(3)
  A0_1776:SetupInventoryOnDeath()
end
function ArkPoltergeist_x.OnLureSignal(A0_1777, A1_1778, A2_1779, A3_1780)
  A0_1777.arknpc:OnLured(A1_1778)
end
