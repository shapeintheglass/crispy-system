...
ArkWeaver_x = {
  ...
  Properties = {
    ...
    RaisePhantom = {attachmenteffects_raisePhantomFromCorpseCast = ""},
...
function ArkWeaver_x.IsInvulnerable(A0_1817)
  local L1_1818
  L1_1818 = A0_1817.PropertiesInstance
  L1_1818 = L1_1818.bIsInvulnerable
  L1_1818 = L1_1818 == true
  return L1_1818
end
function ArkWeaver_x.OnLureSignal(A0_1819, A1_1820, A2_1821, A3_1822)
  A0_1819.arknpc:OnLured(A1_1820)
end
function ArkWeaver_x.OnNpcKilled(A0_1823)
  A0_1823:SetupInventoryOnDeath()
end
