...
function ArkNightmare_x.OnResetCustom(A0_1688, A1_1689, A2_1690)
  A0_1688:Activate(0)
  A0_1688.arknpc:StopCharacterEffect(CHARACTEREFFECTTYPE_FROZENINGOO)
  if A1_1689 then
    A0_1688:ResetContainer()
    A0_1688:InitInventory()
  end
end
function ArkNightmare_x.IsInvulnerable(A0_1691)
  local L1_1692
  L1_1692 = A0_1691.PropertiesInstance
  L1_1692 = L1_1692.bIsInvulnerable
  L1_1692 = L1_1692 == true
  return L1_1692
end
function ArkNightmare_x.Server.OnStartGame(A0_1693)
  local L1_1694
end
function ArkNightmare_x.OnLureSignal(A0_1695, A1_1696, A2_1697, A3_1698)
  A0_1695.arknpc:OnLured(A1_1696)
end
function ArkNightmare_x.OnFireThresholdExceeded(A0_1699)
  A0_1699.arknpc:LightOnFire()
end
function ArkNightmare_x.OnFireThesholdFellBelow(A0_1700)
  A0_1700.arknpc:OnFireExpired()
end
function ArkNightmare_x.OnFireAboveThresholdRefresh(A0_1701)
  A0_1701.arknpc:OnFireAboveThresholdRefresh()
end
function ArkNightmare_x.OnDiscHitEtherFormSignal(A0_1702, A1_1703, A2_1704, A3_1705)
  Ark.SendSignalPackage(A0_1702.id, g_localActor.id, g_localActor.id, "243995946787474368")
end
function ArkNightmare_x.OnRecycleBeginCorporeal(A0_1706, A1_1707, A2_1708, A3_1709)
  if A1_1707 ~= nil then
    A0_1706.arknpc:RestrictToEtherForm()
    if A0_1706.nRecycleTimerId ~= -1 then
      Script.KillTimer(nRecycleTimerId)
      A0_1706.nRecycleTimerId = -1
    end
    A0_1706.nRecycleTimerId = Script.SetTimer(4000, A0_1706.OnRecycleTimerEnd, A0_1706)
  end
end
function ArkNightmare_x.OnRecycleTimerEnd(A0_1710)
  A0_1710.arknpc:ClearRestrictToEtherForm()
end
