...
function ArkMedKit.CanUse(A0_3041)
  if g_localActor.arkPlayer:IsAnyTraumaActive() == true and g_localActor.arkPlayer:HasAbility(A0_3041.Properties.ability_cureTraumaAbility) then
    return true
  else
