...
function ArkRecycler.SetFromProperties(A0_4466)
  local L1_4467
end
function ArkRecycler.Init(A0_4468, A1_4469)
end
function ArkRecycler.OnSpawn(A0_4470)
  local L1_4471
end
function ArkRecycler.OnReset(A0_4472)
  local L1_4473
end
function ArkRecycler.Event_PowerOn(A0_4474)
  Ark.SetRecyclerPowered(A0_4474.id, true)
end
function ArkRecycler.Event_PowerOff(A0_4475)
  Ark.SetRecyclerPowered(A0_4475.id, false)
end
function ArkRecycler.OnPostLoad(A0_4476)
  local L1_4477
end
