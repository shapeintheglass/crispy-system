...
function ArkOperatorDispenser.Init(A0_4415, A1_4416)
end
function ArkOperatorDispenser.SetFromProperties(A0_4417)
  local L1_4418
end
function ArkOperatorDispenser.Event_PowerOn(A0_4419)
  Ark.SetOperatorDispenserPowered(A0_4419.id, true)
end
function ArkOperatorDispenser.Event_PowerOff(A0_4420)
  Ark.SetOperatorDispenserPowered(A0_4420.id, false)
end
function ArkOperatorDispenser.Event_Lock(A0_4421)
  Ark.SetOperatorDispenserLocked(A0_4421.id, true)
end
function ArkOperatorDispenser.Event_Unlock(A0_4422)
  Ark.SetOperatorDispenserLocked(A0_4422.id, false)
end
function ArkOperatorDispenser.Event_Spawn(A0_4423)
  Ark.ForceOperatorDispenserSpawn(A0_4423.id)
end
function ArkOperatorDispenser.Event_AssignOperator(A0_4424, A1_4425, A2_4426)
  Ark.OperatorDispenserAssignOperator(A0_4424.id, A2_4426.id)
end
function ArkOperatorDispenser.Event_DahlOn(A0_4427)
  Ark.OperatorDispenserOverrideValues(A0_4427.id, "ArkRobots.Operators\\Generic.MilitaryOperator", 3, 6, 30)
end
function ArkOperatorDispenser.Event_DahlOff(A0_4428)
  Ark.OperatorDispenserClearOverrides(A0_4428.id)
end
function ArkOperatorDispenser.OnReset(A0_4429)
  local L1_4430
end
function ArkOperatorDispenser.OnSpawn(A0_4431)
  local L1_4432
end
