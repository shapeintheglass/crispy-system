...
ArkWeaponGooGrenade = {
  Properties = {
    ...
    bEquippable = 1,
    fLerpSpeed = 10,
    textDisplayName = "@i_weapongoogrenade",
    sHUDIcon = "Goos From a Grenade",
    Description = {textFocusDescription = ""},
    Weapon = {
      anim_Animation = "",
      sAnimTag = "goo",
      sAttachmentName = "weapon",
      archetype_ammo = "ArkProjectiles.Gloo.GlooGrenadeShot",
...
ArkMakeDerivedEntityOverride(ArkWeaponGooGrenade, ArkItem, true)
