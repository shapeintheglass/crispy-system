...
ArkWeaponEMPGrenade = {
  Properties = {
    object_GeometryFP = "Objects/weapons/EmpGrenade/1P/EmpGrenade1P.cdf",
    object_GeometryTP = "Objects/weapons/EmpGrenade/3P/empgrenade3p_01.cgf",
    bEquippable = 1,
    fLerpSpeed = 10,
    textDisplayName = "@i_weaponEMPgrenade",
    sHUDIcon = "recycle",
    ...
    Weapon = {
      ...
      archetype_ammo = "ArkProjectiles.Charges.EMP",
      ...
      sDisarmAttachmentName = "ArkLight_EMP",
      Light = {
...
ArkMakeDerivedEntityOverride(ArkWeaponEMPGrenade, ArkItem, true)
