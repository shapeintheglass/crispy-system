...
ArkWeaponStunGun = {
  Properties = {
    ...
    fLerpSpeed = 10,
    Description = {
      baseDamageKeyword = "%basedamage%",
      finalDamageKeyword = "%finaldamage%",
      signal_damageSignal = ""
    },
    Weapon = {
      playerImpulse = 0,
      ...
      particleeffect_DisruptionVFX = "PlayerWeapons.StunGun.EMP.StunGun_Emp_00",
      sDisruptionVFXAttachName = "fx_electrical_all",
      Light = {
