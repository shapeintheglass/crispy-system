...
function ArkChargeTrap.Event_Trigger(A0_3442)
  BroadcastEvent(A0_3442, "Trigger")
end
function ArkChargeTrap.Event_Disarm(A0_3443)
  BroadcastEvent(A0_3443, "Disarm")
end
