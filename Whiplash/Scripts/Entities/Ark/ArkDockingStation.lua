...
function ArkDockingStation.Init(A0_3567, A1_3568)
end
function ArkDockingStation.SetFromProperties(A0_3569)
  local L1_3570
end
function ArkDockingStation.OnReset(A0_3571)
  local L1_3572
end
function ArkDockingStation.OnSpawn(A0_3573)
  local L1_3574
end
function ArkDockingStation.Event_UndockAll(A0_3575)
  BroadcastEvent(A0_3575, "AllUndocked")
end
