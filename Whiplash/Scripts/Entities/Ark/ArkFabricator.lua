...
function ArkFabricator.SetFromProperties(A0_3796)
  local L1_3797
end
function ArkFabricator.Init(A0_3798, A1_3799)
  if not A0_3798.m_bInit then
    A0_3798.m_bInit = true
    A0_3798:Log("Init")
    A0_3798:SetFromProperties()
  end
end
function ArkFabricator.OnSpawn(A0_3800)
  A0_3800:Log("OnSpawn")
end
function ArkFabricator.OnReset(A0_3801)
  A0_3801:Log("OnReset")
  A0_3801:SetFromProperties()
  A0_3801.m_bInit = false
end
function ArkFabricator.Event_PowerOn(A0_3802)
  Ark.SetFabricatorPowered(A0_3802.id, true)
end
function ArkFabricator.Event_PowerOff(A0_3803)
  Ark.SetFabricatorPowered(A0_3803.id, false)
end
