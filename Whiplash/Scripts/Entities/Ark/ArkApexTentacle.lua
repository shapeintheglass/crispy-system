...
ArkApexTentacle = {
  Properties = {
    ...
    Grab = {
      bGrabEnabled = 0,
      posteffect_GrabPostFX = "",
      fGrabAngle = 90,
      signalpackage_GrabPackage = "10641886185795233761"
    },
    Movement = {
      fSpeed = 1,
      fMaxTurnRadius = 90,
    ...
    Sound = {
      ...
      audioTrigger_Strike = "",
      audioTrigger_GrabTarget = "",
      audioTrigger_ReleaseTarget = ""
    },
    Strike = {
      fStrikeRange = 3,
      fStrikeSpeed = 3.5,
...
function ArkApexTentacle.Init(A0_3341, A1_3342)
end
function ArkApexTentacle.SetFromProperties(A0_3343)
  Ark.RemoveInboundSignalModifier(A0_3343.id, A0_3343.Properties.Damaged.signalmodifier_DefaultModifier)
  Ark.AttachInboundSignalModifier(A0_3343.id, A0_3343.Properties.Damaged.signalmodifier_DefaultModifier)
end
function ArkApexTentacle.OnReset(A0_3344, A1_3345)
  A0_3344:SetFromProperties()
end
function ArkApexTentacle.OnSpawn(A0_3346)
  A0_3346:SetFromProperties()
end
