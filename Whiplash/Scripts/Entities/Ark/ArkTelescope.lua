...
function ArkTelescope.Init(A0_4591, A1_4592)
end
function ArkTelescope.SetFromProperties(A0_4593)
  local L1_4594
end
function ArkTelescope.OnReset(A0_4595, A1_4596)
end
function ArkTelescope.OnSpawn(A0_4597)
  local L1_4598
end
