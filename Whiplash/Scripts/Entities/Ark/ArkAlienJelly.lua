...
function ArkAlienJelly.OnSpawn(A0_3322)
  Ark.AttachInboundSignalModifier(A0_3322.id, A0_3322.Properties.signalmodifier_InboundModifier)
end
function ArkAlienJelly.Event_Dead(A0_3323)
  BroadcastEvent(A0_3323, "Dead")
end
function ArkAlienJelly.Event_Rest(A0_3324)
  BroadcastEvent(A0_3324, "Rest")
end
function ArkAlienJelly.Event_Follow(A0_3325, A1_3326, A2_3327)
  Ark.ForceCystoidToFollow(A0_3325.id, A2_3327.id)
end
function ArkAlienJelly.Event_Attack(A0_3328)
  BroadcastEvent(A0_3328, "Attack")
end
function ArkAlienJelly.Event_ResumeAI(A0_3329)
  BroadcastEvent(A0_3329, "ResumeAI")
end
