...
function AI.OnSave(A0_115, A1_116)
  A1_116.AIBlackBoard = AIBlackBoard
end
function AI.OnLoad(A0_117, A1_118)
  AIBlackBoard_Reset()
  merge(AIBlackBoard, A1_118.AIBlackBoard)
end
function AI.OnEditorMoveSimulation(A0_119, A1_120, A2_121, A3_122)
  AI.SetRefPointPosition(A1_120.id, A3_122)
  A1_120:InsertSubpipe(AIGOALPIPE_SAMEPRIORITY, "MoveToMiddleClickPositionInEditor", nil, A2_121)
end
