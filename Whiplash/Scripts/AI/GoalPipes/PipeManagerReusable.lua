function PipeManager.InitReusable(A0_58)
  ...
  AI.PushGoal("order_timeout", "timeout", 1, 0.3, 1)
  ...
  AI.PushGoal("action_enter", "locate", 0, "animtarget")
  ...
  AI.PushGoal("action_exit", "waitsignal", 1, "EXITING_END", nil, 10)
  ...
  AI.PushGoal("action_unload", "waitsignal", 0, "UNLOAD_DONE", nil, 10)
