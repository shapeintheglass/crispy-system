function PipeManager.InitHuman(A0_57)
  ...
  AI.PushGoal("look", 1, AILOOKMOTIVATION_GLANCE, 0, AILASTOPRES_USE)
  ...
  AI.PushGoal("stickminimumdistance", 1, 7, AILASTOPRES_USE + AI_REQUEST_PARTIAL_PATH, STICK_BREAK)
  AI.PushGoal("firecmd", 1, FIREMODE_BURST_WHILE_MOVING)
  AI.PushLabel("Loop")
  AI.PushGoal("signal", 1, 1, "VerifyFlankPositionIsGood", 0)
  AI.PushGoal("branch", 1, "GetCloseToTarget", IF_TARGET_DIST_GREATER, 7)
  ...
  AI.PushGoal("firecmd", 1, FIREMODE_BURST)
  AI.PushGoal("adjustaim", 1, ADJUSTAIM_AIM, 20)
  AI.PushGoal("timeout", 1, 1)
  AI.EndGoalPipe()
  AI.BeginGoalPipe("SniperEngageTargetAtCloseRange")
  AI.PushGoal("ReactToPressure")
  AI.EndGoalPipe()
