...
<AnimDB FragDef="Animations/Mannequin/ADB/Ai_Nightmare_FragmentIds.xml" TagDef="Animations/Mannequin/ADB/Ai_Nightmare_Tags.xml">
 ...
 <FragmentBlendList>
  ...
  <Blend from="Motion_Move" to="Motion_Move">
   <Variant from="Strafe" to="">
    <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" selectTime="0" startTime="0.0023946762" enterTime="0" flags="Cyclic+CycleLocked">
     <AnimLayer>
      <Blend ExitTime="0.4749999" StartTime="0.30000001" Duration="0.40000001" terminal="1"/>
     </AnimLayer>
    </Fragment>
   </Variant>
   <Variant from="" to="Strafe">
    <Fragment BlendOutDuration="0.2" Weight="1" Cooldown="0" selectTime="0" startTime="0.0021415949" enterTime="0" flags="Cyclic+CycleLocked">
     <AnimLayer>
      <Blend ExitTime="0.45000005" StartTime="0.30000001" Duration="0.40000001" terminal="1"/>
     </AnimLayer>
    </Fragment>
   </Variant>
  </Blend>
